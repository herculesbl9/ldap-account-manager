    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
          ...
          $result = ldap_mod_add($ldap_con, $group_name, $group_info);
          ...
          <?php  } else { ?>
            ...
            <div class="alert alert-danger d-flex align-items-center mt-3 mb-3" role="alert">
              ...
              <div>
                Υπήρξε κάποιο πρόβλημα με την απενεργοποίηση του χρήστη.
              </div>
            </div>
          <?php }
          //Deactivates the user in Rocket.Chat
          ...
          if (!$rs) { ?>
            <div class="alert alert-success d-flex align-items-center mt-3 mb-3" role="alert">
              ...
              <div>
                Ο λογαρασμος του χρήστη στο Rocket.Chat τέθηκε σε κατάσταση Disabled.
              </div>
            </div>
          <?php  } else { ?>
            ...
            <div class="alert alert-danger d-flex align-items-center mt-3 mb-3" role="alert">
              ...
              <div>
                Υπήρξε πρόβλημα με τη διασύνδεση με το Rocket.Chat, ο λογαριασμός του χρήστη εκεί θα πρέπει να απενεργοποιηθεί χειροκίνητα.
              </div>
            </div>
        <?php }
        }
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Απενεργοποίηση του χρήστη <?php echo $_GET['user'] ?></h1>
        </div>
        <p>Επιχειρείτε να απενεργοποιήσετε τον λογαριασμό του χρήστη <?php echo $_GET['user'] ?>. Με την απενεργοποίηση του λογαριασμού, ο χρήστης δε θα μπορεί
          να συνδεθεί στο Rocket.Chat, το 4minitz, την ιστοσελίδα της ομάδας και την υπηρεσία διαχείρησης λογαριασμών. <br>
          Επιπλέον, ο λογαριασμός του χρήστη στο Rocket.Chat, μετέρχεται αυτόματα στην κατάσταση Deactivated, ενώ τα στοιχεία του χρήστη δε θα επιστρέφονται πλέον
          από την αναζήτηση χρηστών στον παρόν ιστότοπο.</p>
        <form action="deactivate.php?user=<?php echo $_GET["user"] ?>" method="POST">
          <input type="text" id="uid" name="uid" hidden value=<?php echo $_GET['user']; ?>>
          <button type="submit" class="btn btn-outline-danger">Απενεργοποίηση</button>
        </form>
      </main>
    </div>
  </div>
