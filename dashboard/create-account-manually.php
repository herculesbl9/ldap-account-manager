      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="alert alert-primary d-flex align-items-center" role="alert">
          ...
          <div>
            ...
            Σε περίπτωση που θέλετε να χρησιμοποιήσετε τη φόρμα αυτόματης συμπλήρωσης, πατήστε <a href="create-account.php" class="alert-link">εδώ</a>.
          </div>
        </div>
        <div class="container-fluid">
          <form action="submit-new.php" method="POST" class="row g-3 needs-validation" oninput="cpassword.setCustomValidity(password.value != cpassword.value ? '0' : '');name.setCustomValidity(!/^[a-zA-Z]+$/.test(name.value) ? '0' : '');surname.setCustomValidity(!/^[a-zA-Z]+$/.test(surname.value) ? '0' : '')" novalidate>
            <div class="col-md-6">
              ...
              <input type="text" placeholder="Λατινικοί χαρακτήρες" class="form-control" id="name" name="name" required>
            ...
            <div class="col-md-6">
              ...
              <input type="text" placeholder="Λατινικοί χαρακτήρες" class="form-control" id="surname" name="surname" required>
              <div class="invalid-feedback">Αυτό το πεδίο είναι υποχρεωτικό και πρέπει να συμπληρωθεί με λατινικούς χαρακτήρες.</div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="displayname" name="displayname" placeholder="Name Surname" required>
            </div>
            <div class="col-md-6">
              <label for="homedir" class="form-label">Home Directory</label>
              <input type="text" class="form-control" id="homedir" name="homedir" placeholder="/home/username" required>
            </div>
            <div class="col-md-6">
              <label for="cn" class="form-label">Common Name</label>
              <input type="text" class="form-control" id="cn" name="cn" placeholder="namesurname" required>
            </div>
            <div class="col-md-6">
              <label for="loginshell" class="form-label">Login Shell</label>
              <input type="text" class="form-control" id="loginshell" name="loginshell" value="/bin/bash" required>
            </div>
            <div class="col-md-6">
              <label for="uidnumber" class="form-label">UID</label>
              <input type="text" class="form-control" id="uidnumber" value=<?php echo $info[0]['serialnumber'][0]+1; ?> name="uidnumber" required>
            </div>
            <div class="col-md-6">
