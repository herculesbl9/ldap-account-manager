      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
          <div class="alert alert-danger" role="alert">
            <h4 class="alert-heading">Ανεπαρκή Δικαιώματα Πρόσβασης</h4>
            <p>Φαίνεται πως προσπαθήσατε να αποκτήσετε πρόσβαση σε κάποια σελίδα που απαιτεί δικαιώματα διαχειριστή.</p>
            <hr>
            <p class="mb-0">Σε περίπτωση που έχει γίνει κάποιο λάθος, επικοινωνήστε με το <a href="mailto:mail@example.com">mail@example.com</a>.</p>
          </div>
        </div>
